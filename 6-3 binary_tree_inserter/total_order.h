...
/// Corner case for the tree<>. total_order_iterator should skip tree<> in its
/// output at all costs.
template <class ...Stack>
struct total_order_iterator<number<1>, tree<>, Stack...>
    : mpl::next<total_order_iterator<number<3>, tree<>, Stack...>>::type
{};
...
using oneNode = tree<int, tree<>, tree<>>;

static_assert(
    mpl::equal<
        total_order_view<oneNode>,
